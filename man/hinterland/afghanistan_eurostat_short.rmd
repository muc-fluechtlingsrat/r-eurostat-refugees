...
Wir beschränken unsere Analyse also auf 15 Länder. Was für Entscheidungstypen haben wir überhaupt? Positive und negative, wobei sich die positiven feiner unterteilen. Die Bedeutung der Aufenthaltstitel wird von Land zu Land verschieden sein, das macht Vergleiche schwierig. Die Ablehnungsquote sollte trotzdem vergleichbar sein.
...
![Entscheidungen in Europa 2017, Irak, in Prozent](./Irak_dec_2017_pct.png)

Beim Iran ist das Bild wieder ausgeglichener.

![Entscheidungen in Europa 2017, Iran, in Prozent](./Iran_dec_2017_pct.png)

Nigeria und Pakistan -  Hier liegt der Anteil Entscheidungen aus Deutschland übrigens nur bei etwa einem Drittel

![Entscheidungen in Europa 2017, Nigeria, in Prozent](./Nigeria_dec_2017_pct.png)

![Entscheidungen in Europa 2017, Pakistan, in Prozent](./Pakistan_dec_2017_pct.png)

Eritrea:

![Entscheidungen in Europa 2017, Eritrea, in Prozent](./Eritrea_dec_2017_pct.png)
...
Der Vergleich der Anerkennungsquoten in Europa zeigt große Unterschiede. Er ist erschwert dadurch, dass die Entscheidungen sehr ungleich auf die Aufnahmeländer verteilt sind. Es ist trotzdem erkennbar, dass die Behauptung, es spiele keine Rolle spiele, wo der Antrag gestellt wird, bei den Herkunftsländern Afghanistan und Eritrea unhaltbar.
...
### Über den Refugee Datathon Munich 
